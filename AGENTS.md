...
> **NOTE:** All new AGENTS.md entries should instead be made in CLAUDE.md (~/CLAUDE.md) for cross-platform compatibility. CLAUDE.md auto-loads in both Claude Code and Hermes sessions. This file is for hermes-agent repo-specific dev guide content only.
